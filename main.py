...
computer  = "more than 10"
keyboard = "more than 10"
music = "rap"
print(f"There are {computer} computers in the room and there is also {keyboard} keyboards in here. I am sitting here listening to {music}.")
